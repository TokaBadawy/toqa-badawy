...
class ProductController extends Controller
{
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        return redirect()->route('Project.products.index')->with('success','Created Successfully');
    }
    ...
    public function update(UpdateProductRequest $request,$id){
        ...
        return redirect()->route('Project.products.index')->with('success','Updated Successfully');
