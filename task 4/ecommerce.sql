...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2022 at 02:05 PM
...
CREATE TABLE `brands` (
  ...
  `status` tinyint(1) DEFAULT 1 COMMENT '1=>active, o=>not active',
  `image` varchar(255) NOT NULL DEFAULT 'default.png',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `cities` (
  ...
  `name_en` varchar(32) NOT NULL,
  `name_ar` varchar(32) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1=>availlable_for delivery,0=>unavailable for delivery',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `coupons` (
  ...
  `mini_order` smallint(1) NOT NULL DEFAULT 1,
  `number_of_usage_per_user` smallint(1) NOT NULL DEFAULT 1,
  `max_number_of_usage` smallint(3) NOT NULL DEFAULT 1,
...
CREATE TABLE `offer_products` (
  ...
  `price_after_discount` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `orders` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `tota_price` decimal(7,2) NOT NULL,
  `status` tinyint(1) NOT NULL COMMENT '0=>cancelled,1=>checked,2=>on his way,3=>delivered',
...
CREATE TABLE `regions` (
  ...
  `name_en` varchar(32) NOT NULL,
  `name_ar` varchar(32) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1=>available_for_deleviery, 0=>not available_for deleviery',
...
--
ALTER TABLE `offer_products`
  ADD CONSTRAINT `offer_products_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `offer_products_ibfk_2` FOREIGN KEY (`offer_id`) REFERENCES `offers` (`id`);
